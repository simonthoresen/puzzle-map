...
|------------------|------------------------|----------|
| **Locations**    | `hunts/locations.md`   | All hiding spots grouped by zone, with zone map and distances |
| **Game setup**   | `hunts/players.md`     | Occasion, goal, start location, language, stair counts, and any house-specific rules |
| **Player profiles** | `hunts/players.md` | Per-player: name, age, interests, friends, schools, personal facts, Easter-egg location |
...
File naming: `hunts/puzzles-{player-name-lowercase}.md`

### 4. Write the trail file

Output a single `hunts/trails.md` following the template in
...
`hunts/puzzles-{name}-simple.md` alongside the standard version.
